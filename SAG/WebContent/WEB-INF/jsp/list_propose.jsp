...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
  ...
  <body onload="refresh_account()">
		...
		<nav class="top-bar" data-topbar>
		   ...
		   <section class="middle tab-bar-section">
				...
				<ul class="left">
				  ...
				  <li class="divider"></li>
				  <li class="active"><a href="list.html">Toutes les offres</a></li>
				  <li class="divider"></li>
				...
				<ul id="rightmenu" class="right">
				  <li class="has-dropdown">
					...
					<ul class="dropdown">
						  ...
						  <li id="offers" class="active"><a href="list_propose1.html">Consulter ses offres</a></li>
    ...
    <div class="row">
      <div class="large-12 columns">
      	<div class="panel">
        <h3>Liste des propositions d'offre</h3>
		<div class="row">
				 <table>
				  <thead>
					<tr>
				  ...
				  <tbody>
					<tr>
					  <td><a href="detail_offre1.html">Oreillets mÃ©moire de forme</a></td>
					  <td>Literie</td>
					  <td>59â¬</td>
					  <td>02/03/14</td>
					  <td>
						<a href="detail_offre1.html" class="tiny button split">Actions<span data-dropdown="drop1"></span></a><br>
