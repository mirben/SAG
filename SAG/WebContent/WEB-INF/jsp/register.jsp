...
<body>
	<div class="row">
		<div class="large-8 columns">
			...
			<div class="row">
				<div class="large-12 columns">
					...
					<div class="panel">
						<div class="row">
							<form:form method="post" commandName="etudiant"
								accept-charset="utf-8">
								<dl class="tabs" data-tab="">
									<dd class="active">
										<a href="#panel2-1">Informations personnelles</a>
									</dd>
									<dd>
										<a href="#panel2-2">Domaines</a>
									</dd>
								</dl>
									...
									<div class="content active" id="panel2-1">
										<div class="row">
											<div class="large-4 columns">
												<label>Nom <form:input path="nom" placeholder="Nom" />
										...
										<div class="row">
											<div class="large-4 columns">
												<label>Prénom <form:input path="prenom"
														placeholder="Prénom" /> <form:errors path="prenom"
														cssClass="error" />
												</label>
											</div>
										</div>
										<div class="row">
											<div class="large-4 columns">
												<label>Identifiant ENT <form:input path="logENT"
														placeholder="Identifiant ENT" /> <form:errors
														path="logENT" cssClass="error" />
												</label>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="large-8 columns">
												<label>Adresse Postale <form:textarea path="adresse"
														placeholder="Adresse postale complète" /> <form:errors
										...
										<div class="row">
											<div class="large-6 columns">
												...
												<form:select path="domaines" class="domlist">
													<form:options items="${domains}" itemValue="id"
														itemLabel="nom" />
												</form:select>
											</div>
										</div>
		...
		<div id="myModal" class="reveal-modal" data-reveal="">
			...
			<p>Un email vous sera envoyé à  l'adresse renseignée dès que
				votre inscription aura été validée.</p>
